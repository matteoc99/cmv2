                ...
                <div class="row" style="display: flex; flex: 1">
                    ...
                    <div class="input-field col s8" style="align-self: flex-end">
                        <button type="button" class="btn waves-effect waves-light blue darken-4"
                                onclick="document.getElementById('profile_image').click()"> @lang("settings.changeProfilePicture")
                        </button>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <label for="firm_name" data-error="wrong"
                                   data-success="right">@lang("settings.firmName")</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <label for="phone" data-error="wrong"
                                   data-success="right"> @lang("settings.phone")</label>
                        </div>
                    </div>
                    <div class="input-field col s12">
                        ...
                        <label>@lang("settings.tags")</label>
                    </div>
                @endif
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <label for="first_name" data-error="wrong"
                               data-success="right"> @lang("settings.firstName") </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <label for="last_name" data-error="wrong"
                               data-success="right"> @lang("settings.lastName")</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <label for="desc" data-error="wrong"
                               data-success="right"> @lang("settings.description")</label>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <label for="address" data-error="wrong"
                                   data-success="right"> @lang("settings.address")</label>
                        </div>
                    </div>
                @endif
                @if(\Illuminate\Support\Facades\Auth::user()->isCraftsman())
                ...
                <div class="row">
                    <div class="input-field col s12 m6 offset-m3">
                        <button type="submit" id="submit"
                                class="btn waves-effect waves-light blue darken-4 col s12">@lang("settings.update")
                        </button>
                    </div>
