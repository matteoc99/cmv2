...
@section("content")
    <div class="container">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Condominium Manager.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Condominium Manager, accessible from <a
                        href="https://condominium-manager.it/" rel="external nofollow noopener" target="_blank">https://condominium-manager.it/</a>
                </p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: matteo.cosi@live.it</li>
        </ul>
    </div>
@endsection
