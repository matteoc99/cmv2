    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l8 xl6 card offset-l2 offset-xl3">
                <ul class="tabs">
                    <li class="tab col s6"><a href="#profile" class="blue-text darken-4">Profile</a></li>
                    <li class="tab col s6"><a href="#notification" class="blue-text darken-4">Notifications</a></li>
                </ul>
            </div>
